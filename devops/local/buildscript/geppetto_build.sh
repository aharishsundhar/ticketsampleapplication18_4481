...
APPLICATION='/ticketsampleapplication18'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication18-desktop:1.0'
...
helm install --name ticketsampleapplication18-4481 ./helm
if [ $? -eq 0 ]; then
